...
{
    public static class WorkerFactory<T1, T2, T3, T4, T5>
    {
            ...
            where TWorker : struct, IWorker<T1, T2, T3, T4, T5>
        {
            try
            {
                return WorkFacadeFactory
                    .Instantiate<IWorkerWrapper<T1, T2, T3, T4, T5>, IMultiContainer<T1, T2, T3, T4, T5>, T1, T2, T3, T4
                        , T5>(
                        testName,
                        WorkerWrapperFactory<IWorkConfig>.Instantiate<TWorker, T1, T2, T3, T4, T5>(workConfig),
                        MultiContainerFactory<IDataConfig>
                            .Instantiate<IInputData<T1, T2, T3, T4, T5>, T1, T2, T3, T4, T5>(
                                new InputData<T1, T2, T3, T4, T5>(itemArray1, itemArray2, itemArray3, itemArray4,
                                    itemArray5),
                                dataConfig
                            )
                    );
