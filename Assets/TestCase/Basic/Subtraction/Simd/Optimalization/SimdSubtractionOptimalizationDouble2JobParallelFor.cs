...
namespace TestCase.Basic.Subtraction.Simd.Optimalization
{
    [BurstCompile]
    public struct SimdSubtractionOptimalizationDouble2JobParallelFor : IJobParallelForExt<double2, double2, double2>
    {
