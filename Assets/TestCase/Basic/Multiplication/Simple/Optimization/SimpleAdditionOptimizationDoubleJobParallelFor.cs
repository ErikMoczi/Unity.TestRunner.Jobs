...
namespace TestCase.Basic.Multiplication.Simple.Optimization
{
    [BurstCompile]
    public struct SimpleMultiplicationOptimizationDoubleJobParallelFor : IJobParallelForExt<NativeArray<double>, NativeArray<double>, NativeArray<double>>
    {
