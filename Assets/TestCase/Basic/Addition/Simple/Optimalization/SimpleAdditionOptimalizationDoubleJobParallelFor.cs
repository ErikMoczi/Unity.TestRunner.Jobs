...
namespace TestCase.Basic.Addition.Simple.Optimalization
{
    [BurstCompile]
    public struct SimpleAdditionOptimalizationDoubleJobParallelFor : IJobParallelForExt<double, double, double>
    {
