...
namespace TestCase.Basic.Division.Optimalization
{
    [BurstCompile]
    public struct SimpleDivisionOptimalizationDoubleJobParallelFor : IJobParallelForExt<double, double, double>
    {
