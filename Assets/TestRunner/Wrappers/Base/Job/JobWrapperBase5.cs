...
namespace TestRunner.Wrappers.Base.Job
{
    internal abstract class
        JobWrapperBase<TDataContainer, TData, TWorker, TConfig, T1, T2, T3, T4, T5> : JobWrapperBase<TDataContainer,
        ...
        where TWorker : struct, IJobBase<T1, T2, T3, T4, T5>
        ...
        where T5 : struct
    {
        ...
        {
            return new StructContainer<TConfig, T1, T2, T3, T4, T5>(data.ItemArray1, data.ItemArray2,
