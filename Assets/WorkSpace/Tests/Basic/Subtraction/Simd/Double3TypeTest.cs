    ...
    public sealed class Double3TypeTest : SampleGenerator
    {
        ...
        public override ITestFacade[] InitTestFacades(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                ...
                WorkerTests<NativeArray<double3>, NativeArray<double3>, NativeArray<double3>>
                    .Run<SimdSubtractionDouble3JobParallelFor>(
                        TestName(),
                        inputDataContainer.GetData<double3>(DataConfig.DataDouble3),
                        inputDataContainer.GetData<double3>(DataConfig.DataDouble3),
                        inputDataContainer.GetData<double3>(DataConfig.DataDouble3),
                ...
                WorkerTests<double3[], double3[], double3[]>.Run<SimdSubtractionDouble3Plain>(
                    TestName(),
                    inputDataContainer.GetData<double3>(DataConfig.DataDouble3),
                    inputDataContainer.GetData<double3>(DataConfig.DataDouble3),
                    inputDataContainer.GetData<double3>(DataConfig.DataDouble3),
                ...
                WorkerTests<double3[], double3[], double3[]>.Run<SimdSubtractionDouble3SystemParallelFor>(
                    TestName(),
                    inputDataContainer.GetData<double3>(DataConfig.DataDouble3),
                    inputDataContainer.GetData<double3>(DataConfig.DataDouble3),
                    inputDataContainer.GetData<double3>(DataConfig.DataDouble3),
