...
namespace WorkSpace.Tests.Basic.Subtraction.Simd.Optimalization
{
    public sealed class TripleTypeDouble4Test : SampleGenerator
    {
        ...
        public override IWorkWrapper[] InitWorkWrappers(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                WorkerTests<double4, double4, double4>.RunIJob(TestName, new SimdSubtractionOptimalizationDouble4Job(),
                ...
                WorkerTests<double4, double4, double4>.RunIJobParallelFor(TestName,
                    new SimdSubtractionOptimalizationDouble4JobParallelFor(),
                    inputDataContainer.GetData<double4>(DataConfig.DataDouble4),
                    inputDataContainer.GetData<double4>(DataConfig.DataDouble4),
                    inputDataContainer.GetData<double4>(DataConfig.DataDouble4),
