...
namespace WorkSpace.Tests.Basic.Subtraction.Simd
{
    public sealed class Int3TypeTest : SampleGenerator
    {
        ...
        public override ITestFacade[] InitTestFacades(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                WorkerTests<NativeArray<int3>, NativeArray<int3>, NativeArray<int3>>.Run<SimdSubtractionInt3Job>(
                    TestName(),
                ...
                WorkerTests<NativeArray<int3>, NativeArray<int3>, NativeArray<int3>>
                    .Run<SimdSubtractionInt3JobParallelFor>(
                        TestName(),
                        inputDataContainer.GetData<int3>(DataConfig.DataInt3),
                        inputDataContainer.GetData<int3>(DataConfig.DataInt3),
                        inputDataContainer.GetData<int3>(DataConfig.DataInt3),
                ...
                WorkerTests<int3[], int3[], int3[]>.Run<SimdSubtractionInt3Plain>(
                    TestName(),
                    inputDataContainer.GetData<int3>(DataConfig.DataInt3),
                    inputDataContainer.GetData<int3>(DataConfig.DataInt3),
                    inputDataContainer.GetData<int3>(DataConfig.DataInt3),
                ...
                WorkerTests<int3[], int3[], int3[]>.Run<SimdSubtractionInt3SystemParallelFor>(
                    TestName(),
                    inputDataContainer.GetData<int3>(DataConfig.DataInt3),
                    inputDataContainer.GetData<int3>(DataConfig.DataInt3),
                    inputDataContainer.GetData<int3>(DataConfig.DataInt3),
