        ...
        public override IWorkFacade[] InitWorkFacades(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                WorkerFactory<NativeArray<float4>, NativeArray<float4>, NativeArray<float4>>
                    .Create<SimdSubtractionFloat4Job>(
                        TestName(),
                ...
                WorkerFactory<NativeArray<float4>, NativeArray<float4>, NativeArray<float4>>
                    .Create<SimdSubtractionFloat4JobParallelFor>(
                        TestName(),
                        inputDataContainer.GetData<float4>(TypeConfig.DataFloat4),
                        inputDataContainer.GetData<float4>(TypeConfig.DataFloat4),
                        inputDataContainer.GetData<float4>(TypeConfig.DataFloat4),
                ...
                WorkerFactory<float4[], float4[], float4[]>.Create<SimdSubtractionFloat4Plain>(
                    TestName(),
                    inputDataContainer.GetData<float4>(TypeConfig.DataFloat4),
                    inputDataContainer.GetData<float4>(TypeConfig.DataFloat4),
                    inputDataContainer.GetData<float4>(TypeConfig.DataFloat4),
                ...
                WorkerFactory<float4[], float4[], float4[]>.Create<SimdSubtractionFloat4SystemParallelFor>(
                    TestName(),
                    inputDataContainer.GetData<float4>(TypeConfig.DataFloat4),
                    inputDataContainer.GetData<float4>(TypeConfig.DataFloat4),
                    inputDataContainer.GetData<float4>(TypeConfig.DataFloat4),
