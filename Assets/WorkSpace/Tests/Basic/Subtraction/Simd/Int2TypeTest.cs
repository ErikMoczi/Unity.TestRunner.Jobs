...
namespace WorkSpace.Tests.Basic.Subtraction.Simd
{
    public sealed class Int2TypeTest : SampleGenerator
    {
        ...
        public override ITestFacade[] InitTestFacades(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                WorkerTests<NativeArray<int2>, NativeArray<int2>, NativeArray<int2>>.Run<SimdSubtractionInt2Job>(
                    TestName(),
                ...
                WorkerTests<NativeArray<int2>, NativeArray<int2>, NativeArray<int2>>
                    .Run<SimdSubtractionInt2JobParallelFor>(
                        TestName(),
                        inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                        inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                        inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                ...
                WorkerTests<int2[], int2[], int2[]>.Run<SimdSubtractionInt2Plain>(
                    TestName(),
                    inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                    inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                    inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                ...
                WorkerTests<int2[], int2[], int2[]>.Run<SimdSubtractionInt2SystemParallelFor>(
                    TestName(),
                    inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                    inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                    inputDataContainer.GetData<int2>(DataConfig.DataInt2),
