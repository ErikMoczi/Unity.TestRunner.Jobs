...
namespace WorkSpace.Tests.Basic.Subtraction.Simd
{
    public sealed class Int2TypeTest : SampleGenerator
    {
        ...
        public override IWorkFacade[] InitWorkFacades(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                WorkerFactory<NativeArray<int2>, NativeArray<int2>, NativeArray<int2>>.Create<SimdSubtractionInt2Job>(
                    TestName(),
                ...
                WorkerFactory<NativeArray<int2>, NativeArray<int2>, NativeArray<int2>>
                    .Create<SimdSubtractionInt2JobParallelFor>(
                        TestName(),
                        inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                        inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                        inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                ...
                WorkerFactory<int2[], int2[], int2[]>.Create<SimdSubtractionInt2Plain>(
                    TestName(),
                    inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                    inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                    inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                ...
                WorkerFactory<int2[], int2[], int2[]>.Create<SimdSubtractionInt2SystemParallelFor>(
                    TestName(),
                    inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                    inputDataContainer.GetData<int2>(DataConfig.DataInt2),
                    inputDataContainer.GetData<int2>(DataConfig.DataInt2),
