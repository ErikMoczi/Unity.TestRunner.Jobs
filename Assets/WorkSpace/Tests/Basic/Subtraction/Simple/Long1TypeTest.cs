...
namespace WorkSpace.Tests.Basic.Subtraction.Simple
{
    public sealed class Long1TypeTest : SampleGenerator
    {
        ...
        public override ITestFacade[] InitTestFacades(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                WorkerTests<NativeArray<long>, NativeArray<long>, NativeArray<long>>.Run<SimpleSubtractionLongJob>(
                    TestName(),
                ...
                WorkerTests<NativeArray<long>, NativeArray<long>, NativeArray<long>>
                    .Run<SimpleSubtractionLongJobParallelFor>(
                        TestName(),
                        inputDataContainer.GetData<long>(DataConfig.DataLong1),
                        inputDataContainer.GetData<long>(DataConfig.DataLong1),
                        inputDataContainer.GetData<long>(DataConfig.DataLong1),
                ...
                WorkerTests<long[], long[], long[]>.Run<SimpleSubtractionLongPlain>(
                    TestName(),
                    inputDataContainer.GetData<long>(DataConfig.DataLong1),
                    inputDataContainer.GetData<long>(DataConfig.DataLong1),
                    inputDataContainer.GetData<long>(DataConfig.DataLong1),
                ...
                WorkerTests<long[], long[], long[]>.Run<SimpleSubtractionLongSystemParallelFor>(
                    TestName(),
                    inputDataContainer.GetData<long>(DataConfig.DataLong1),
                    inputDataContainer.GetData<long>(DataConfig.DataLong1),
                    inputDataContainer.GetData<long>(DataConfig.DataLong1),
