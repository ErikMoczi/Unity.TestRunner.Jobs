        ...
        public override ITestFacade[] InitTestFacades(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                WorkerTests<NativeArray<float4>, NativeArray<float4>, NativeArray<float4>>
                    .Run<SimdMultiplicationFloat4Job>(
                        TestName(),
                ...
                WorkerTests<NativeArray<float4>, NativeArray<float4>, NativeArray<float4>>
                    .Run<SimdMultiplicationFloat4JobParallelFor>(
                        TestName(),
                        inputDataContainer.GetData<float4>(DataConfig.DataFloat4),
                        inputDataContainer.GetData<float4>(DataConfig.DataFloat4),
                        inputDataContainer.GetData<float4>(DataConfig.DataFloat4),
                ...
                WorkerTests<float4[], float4[], float4[]>.Run<SimdMultiplicationFloat4Plain>(
                    TestName(),
                    inputDataContainer.GetData<float4>(DataConfig.DataFloat4),
                    inputDataContainer.GetData<float4>(DataConfig.DataFloat4),
                    inputDataContainer.GetData<float4>(DataConfig.DataFloat4),
                ...
                WorkerTests<float4[], float4[], float4[]>.Run<SimdMultiplicationFloat4SystemParallelFor>(
                    TestName(),
                    inputDataContainer.GetData<float4>(DataConfig.DataFloat4),
                    inputDataContainer.GetData<float4>(DataConfig.DataFloat4),
                    inputDataContainer.GetData<float4>(DataConfig.DataFloat4),
