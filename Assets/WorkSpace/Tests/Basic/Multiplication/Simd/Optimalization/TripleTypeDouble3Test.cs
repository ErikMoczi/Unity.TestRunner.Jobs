...
namespace WorkSpace.Tests.Basic.Multiplication.Simd.Optimalization
{
    public sealed class TripleTypeDouble3Test : SampleGenerator
    {
        ...
        public override IWorkWrapper[] InitWorkWrappers(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                WorkerTests<double3, double3, double3>.RunIJob(TestName, new SimdMultiplicationOptimalizationDouble3Job(),
                ...
                WorkerTests<double3, double3, double3>.RunIJobParallelFor(TestName,
                    new SimdMultiplicationOptimalizationDouble3JobParallelFor(),
                    inputDataContainer.GetData<double3>(DataConfig.DataDouble3),
                    inputDataContainer.GetData<double3>(DataConfig.DataDouble3),
                    inputDataContainer.GetData<double3>(DataConfig.DataDouble3),
