...
namespace WorkSpace.Tests.Basic.Addition.Simd
{
    public sealed class UInt4TypeTest : SampleGenerator
    {
        ...
        public override ITestFacade[] InitTestFacades(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                WorkerTests<NativeArray<uint4>, NativeArray<uint4>, NativeArray<uint4>>.Run<SimdAdditionUInt4Job>(
                    TestName(),
                ...
                WorkerTests<NativeArray<uint4>, NativeArray<uint4>, NativeArray<uint4>>
                    .Run<SimdAdditionUInt4JobParallelFor>(
                        TestName(),
                        inputDataContainer.GetData<uint4>(DataConfig.DataUInt4),
                        inputDataContainer.GetData<uint4>(DataConfig.DataUInt4),
                        inputDataContainer.GetData<uint4>(DataConfig.DataUInt4),
                ...
                WorkerTests<uint4[], uint4[], uint4[]>.Run<SimdAdditionUInt4Plain>(
                    TestName(),
                    inputDataContainer.GetData<uint4>(DataConfig.DataUInt4),
                    inputDataContainer.GetData<uint4>(DataConfig.DataUInt4),
                    inputDataContainer.GetData<uint4>(DataConfig.DataUInt4),
                ...
                WorkerTests<uint4[], uint4[], uint4[]>.Run<SimdAdditionUInt4SystemParallelFor>(
                    TestName(),
                    inputDataContainer.GetData<uint4>(DataConfig.DataUInt4),
                    inputDataContainer.GetData<uint4>(DataConfig.DataUInt4),
                    inputDataContainer.GetData<uint4>(DataConfig.DataUInt4),
