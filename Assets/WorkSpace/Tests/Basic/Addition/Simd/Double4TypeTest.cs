    ...
    public sealed class Double4TypeTest : SampleGenerator
    {
        ...
        public override ITestFacade[] InitTestFacades(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                ...
                WorkerTests<NativeArray<double4>, NativeArray<double4>, NativeArray<double4>>
                    .Run<SimdAdditionDouble4JobParallelFor>(
                        TestName(),
                        inputDataContainer.GetData<double4>(DataConfig.DataDouble4),
                        inputDataContainer.GetData<double4>(DataConfig.DataDouble4),
                        inputDataContainer.GetData<double4>(DataConfig.DataDouble4),
                ...
                WorkerTests<double4[], double4[], double4[]>.Run<SimdAdditionDouble4Plain>(
                    TestName(),
                    inputDataContainer.GetData<double4>(DataConfig.DataDouble4),
                    inputDataContainer.GetData<double4>(DataConfig.DataDouble4),
                    inputDataContainer.GetData<double4>(DataConfig.DataDouble4),
                ...
                WorkerTests<double4[], double4[], double4[]>.Run<SimdAdditionDouble4SystemParallelFor>(
                    TestName(),
                    inputDataContainer.GetData<double4>(DataConfig.DataDouble4),
                    inputDataContainer.GetData<double4>(DataConfig.DataDouble4),
                    inputDataContainer.GetData<double4>(DataConfig.DataDouble4),
