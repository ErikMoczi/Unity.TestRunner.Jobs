    ...
    internal sealed class Double4TypeTest : SampleGenerator
    {
        ...
        public override IWorkFacade[] InitWorkFacades(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                ...
                WorkerFactory<NativeArray<double4>, NativeArray<double4>, NativeArray<double4>>
                    .Create<SimdAdditionDouble4JobParallelFor>(
                        TestName(),
                        inputDataContainer.GetData<double4>(TypeConfig.DataDouble4),
                        inputDataContainer.GetData<double4>(TypeConfig.DataDouble4),
                        inputDataContainer.GetData<double4>(TypeConfig.DataDouble4),
                ...
                WorkerFactory<double4[], double4[], double4[]>.Create<SimdAdditionDouble4Plain>(
                    TestName(),
                    inputDataContainer.GetData<double4>(TypeConfig.DataDouble4),
                    inputDataContainer.GetData<double4>(TypeConfig.DataDouble4),
                    inputDataContainer.GetData<double4>(TypeConfig.DataDouble4),
                ...
                WorkerFactory<double4[], double4[], double4[]>.Create<SimdAdditionDouble4SystemParallelFor>(
                    TestName(),
                    inputDataContainer.GetData<double4>(TypeConfig.DataDouble4),
                    inputDataContainer.GetData<double4>(TypeConfig.DataDouble4),
                    inputDataContainer.GetData<double4>(TypeConfig.DataDouble4),
