...
namespace WorkSpace.Tests.Basic.Addition.Simple
{
    public sealed class Short1TypeTest : SampleGenerator
    {
        ...
        public override ITestFacade[] InitTestFacades(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                WorkerTests<NativeArray<short>, NativeArray<short>, NativeArray<short>>.Run<SimpleAdditionShortJob>(
                    TestName(),
                ...
                WorkerTests<NativeArray<short>, NativeArray<short>, NativeArray<short>>
                    .Run<SimpleAdditionShortJobParallelFor>(
                        TestName(),
                        inputDataContainer.GetData<short>(DataConfig.DataShort1),
                        inputDataContainer.GetData<short>(DataConfig.DataShort1),
                        inputDataContainer.GetData<short>(DataConfig.DataShort1),
                ...
                WorkerTests<short[], short[], short[]>.Run<SimpleAdditionShortPlain>(
                    TestName(),
                    inputDataContainer.GetData<short>(DataConfig.DataShort1),
                    inputDataContainer.GetData<short>(DataConfig.DataShort1),
                    inputDataContainer.GetData<short>(DataConfig.DataShort1),
                ...
                WorkerTests<short[], short[], short[]>.Run<SimpleAdditionShortSystemParallelFor>(
                    TestName(),
                    inputDataContainer.GetData<short>(DataConfig.DataShort1),
                    inputDataContainer.GetData<short>(DataConfig.DataShort1),
                    inputDataContainer.GetData<short>(DataConfig.DataShort1),
