...
namespace WorkSpace.Tests.Basic.Operators.Inequality.Simd
{
    public sealed class TripleTypeBool4Test : SampleGenerator
    {
        ...
        public override IWorkWrapper[] InitWorkWrappers(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                WorkerTests<bool4, bool4, bool4>.RunIJob(TestName, new SimdOperatorsInequalityBool4Job(),
                    inputDataContainer.GetData<bool4>(DataConfig.DataBool4),
                    inputDataContainer.GetData<bool4>(DataConfig.DataBool4),
                    inputDataContainer.GetData<bool4>(DataConfig.DataBool4),
                    new WorkConfigIJob(Allocator.Persistent, true)),
                WorkerTests<bool4, bool4, bool4>.RunIJobParallelFor(TestName, new SimdOperatorsInequalityBool4JobParallelFor(),
                    inputDataContainer.GetData<bool4>(DataConfig.DataBool4),
                    inputDataContainer.GetData<bool4>(DataConfig.DataBool4),
                    inputDataContainer.GetData<bool4>(DataConfig.DataBool4),
