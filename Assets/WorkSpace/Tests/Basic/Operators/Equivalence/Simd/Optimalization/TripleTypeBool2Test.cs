...
namespace WorkSpace.Tests.Basic.Operators.Equivalence.Simd.Optimalization
{
    public sealed class TripleTypeBool2Test : SampleGenerator
    {
        ...
        public override IWorkWrapper[] InitWorkWrappers(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                WorkerTests<bool2, bool2, bool2>.RunIJob(TestName, new SimdOperatorsEquivalenceOptimalizationBool2Job(),
                    inputDataContainer.GetData<bool2>(DataConfig.DataBool2),
                    inputDataContainer.GetData<bool2>(DataConfig.DataBool2),
                    inputDataContainer.GetData<bool2>(DataConfig.DataBool2),
                    new WorkConfigIJob(Allocator.Persistent, true)),
                WorkerTests<bool2, bool2, bool2>.RunIJobParallelFor(TestName,
                    new SimdOperatorsEquivalenceOptimalizationBool2JobParallelFor(),
                    inputDataContainer.GetData<bool2>(DataConfig.DataBool2),
                    inputDataContainer.GetData<bool2>(DataConfig.DataBool2),
                    inputDataContainer.GetData<bool2>(DataConfig.DataBool2),
