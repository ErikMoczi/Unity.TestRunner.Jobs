...
namespace WorkSpace.Tests.Basic.Operators.Equivalence.Simd
{
    public sealed class TripleTypeBool3Test : SampleGenerator
    {
        ...
        public override IWorkWrapper[] InitWorkWrappers(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                WorkerTests<bool3, bool3, bool3>.RunIJob(TestName, new SimdOperatorsEquivalenceBool3Job(),
                    inputDataContainer.GetData<bool3>(DataConfig.DataBool3),
                    inputDataContainer.GetData<bool3>(DataConfig.DataBool3),
                    inputDataContainer.GetData<bool3>(DataConfig.DataBool3),
                    new WorkConfigIJob(Allocator.Persistent, true)),
                WorkerTests<bool3, bool3, bool3>.RunIJobParallelFor(TestName, new SimdOperatorsEquivalenceBool3JobParallelFor(),
                    inputDataContainer.GetData<bool3>(DataConfig.DataBool3),
                    inputDataContainer.GetData<bool3>(DataConfig.DataBool3),
                    inputDataContainer.GetData<bool3>(DataConfig.DataBool3),
