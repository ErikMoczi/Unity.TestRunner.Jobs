...
namespace WorkSpace.Tests.Basic.Operators.Or.Simd
{
    public sealed class TripleTypeBool4Test : SampleGenerator
    {
        ...
        public override IWorkWrapper[] InitWorkWrappers(IInputDataContainer inputDataContainer, int dataSize)
        {
            return new[]
            {
                WorkerTests<bool4, bool4, bool4>.RunIJob(TestName, new SimdOperatorsOrBool4Job(),
                    inputDataContainer.GetData<bool4>(DataConfig.DataBool4),
                    inputDataContainer.GetData<bool4>(DataConfig.DataBool4),
                    inputDataContainer.GetData<bool4>(DataConfig.DataBool4),
                    new WorkConfigIJob(Allocator.Persistent, true)),
                WorkerTests<bool4, bool4, bool4>.RunIJobParallelFor(TestName, new SimdOperatorsOrBool4JobParallelFor(),
                    inputDataContainer.GetData<bool4>(DataConfig.DataBool4),
                    inputDataContainer.GetData<bool4>(DataConfig.DataBool4),
                    inputDataContainer.GetData<bool4>(DataConfig.DataBool4),
